...
Приложение с карточками для изучения иностранных слов.
По функционалу:
...
Игры: тетрис, гонки, виселица и тд. Хорошая практика с множеством концепций, но на любителя)
...
Любое приложение на базе готового API. Дальше по курсу мы будем учиться как работать с открытыми источниками данных и там я покажу массу крутых, уже готовых инструментов. Их можно взять за основу, но более наглядно я покажу дальше.

Взять идею из реальной жизни:
